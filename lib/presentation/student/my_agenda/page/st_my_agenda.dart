...
import 'package:polen_academy/presentation/student/my_agenda/widget/st_agenda_calendar.dart';
import 'package:polen_academy/presentation/student/my_agenda/widget/st_agenda_day_sheet.dart';
              ...
              child: Column(
                ...
                children: [
                  StAgendaCalendar(
                    ...
                    onMonthPrevious: () =>
                        context.read<StMyAgendaCubit>().previousMonth(),
                    onMonthNext: () =>
                        context.read<StMyAgendaCubit>().nextMonth(),
                    onDateTap: (date) {
                      context.read<StMyAgendaCubit>().selectDate(date);
  ...
  void _showDaySheet(BuildContext context, DateTime date) {
    showModalBottomSheet(
      ...
      builder: (ctx) => BlocProvider.value(
        value: context.read<StMyAgendaCubit>(),
        child: DraggableScrollableSheet(
          ...
          builder: (_, scrollController) => SingleChildScrollView(
            ...
            child: StAgendaDaySheet(date: date),
          ),
        ),
      ),
    );
...
class _StUpcomingList extends StatelessWidget {
  const _StUpcomingList({
