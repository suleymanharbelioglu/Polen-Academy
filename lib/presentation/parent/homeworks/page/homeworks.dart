...
class PrHomeworksPage extends StatelessWidget {
  const PrHomeworksPage({super.key});
              ...
              child: BlocBuilder<StHomeworksCubit, StHomeworksState>(
                builder: (context, state) {
                  ...
                  return RefreshIndicator(
                    onRefresh: () =>
                        context.read<StHomeworksCubit>().refresh(),
                    color: AppColors.primaryParent,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          HomeworkWeekNavigation(
                            ...
                            weekNumber: null,
                            onPrevious: () => context
                                .read<StHomeworksCubit>()
                                .previousWeek(),
                            onNext: () =>
                                context.read<StHomeworksCubit>().nextWeek(),
                            showAddWeekly: false,
                          ),
                          ...
                          ...state.weekDays.map((date) {
                            ...
                            return StHomeworkDailyCard(
                              ...
                              state: state,
                              onHomeworkTap: (h) =>
                                  _openDetail(context, state, h, studentId),
                            );
                          }),
                        ],
                      ),
